...
function printReceipt(tags){
	let items = loadAllItems();  //所有商品是信息
	let fun = loadPromotions();  //买二送一的条码
	...
	let result = print(items,promotions,count,kind,sale_result,subtotal);
...
function print(items,promotions,count,kind,sale_result,subtotal){
	 let result='';
	 let t='';
	 result += "***<没钱赚商店>收据***\n";
